...
namespace NetManagement.Model
{
                                        ...
                                        //DropCreateDatabaseAlways<CSDL> // Mỗi lần chạy lại thì sẽ xóa cái cũ và tahy cái mới
    {
        protected override void Seed(CSDL context)
        {
            ...
            { 
                new SalaryEmployee{ CoSalary =18000},
                new SalaryEmployee{ CoSalary =20000},
                new SalaryEmployee{ CoSalary =22000}
            });
            context.SaveChanges();
            ...
            context.Users.AddRange(new User[]{
                ...
                new Employee{ FirstName = "Pham Cong", LastName = "Huy", DateOfBirth  = DateTime.Now, Phone = "0914142564", Email = "abe@gmail.com",Day_Create = DateTime.Now, Gender = true , ID_SalaryEmployee =3,Identify = "12345670"},
            });

            context.StatusShifts.AddRange(new StatusShift[]{
                new StatusShift{ Description = "Đã làm"},
                new StatusShift{ Description = "Chưa làm"},
                new StatusShift{ Description = "Nghỉ phép"},
                new StatusShift{ Description = "Đã chấm công"}
            });
            ...
            context.Users.AddRange(new User[]{
                new Customer{ FirstName = "Nguyen Van", LastName = "Anh", DateOfBirth  = DateTime.Now, Phone = "0914142562", Email = "abc@gmail.com",Day_Create = DateTime.Now, Gender = true ,Money = 1234, ID_Employee =1 },
               ...
               new Customer{ FirstName = "Pham Cong", LastName = "Hai", DateOfBirth  = DateTime.Now, Phone = "0914142564", Email = "abe@gmail.com",Day_Create = DateTime.Now, Gender = true , Money = 1234, ID_Employee =3 }
            });
          
            context.SaveChanges();
            context.UseComputerHistorys.AddRange(new UseComputerHistory[]
            {
                new UseComputerHistory{ ID_HistoryUseComputer = 1,ID_User = 4, ID_Computer =1,_LogIn = DateTime.Now, _LogOut = DateTime.Now},
                new UseComputerHistory{ ID_HistoryUseComputer = 2,ID_User = 5, ID_Computer =2,_LogIn = DateTime.Now, _LogOut = DateTime.Now},
                new UseComputerHistory{ ID_HistoryUseComputer = 3,ID_User = 6, ID_Computer =3,_LogIn = DateTime.Now, _LogOut = DateTime.Now},
            });
            context.Shifts.AddRange(new Shift[]{
                new Shift{ID_Employee = 2, WorkedDate = Convert.ToDateTime("06-13-2022"),ShiftStartTime= "07:00",ShiftEndTime = "12:00", ID_StatusShift = 2},
                new Shift{ ID_Employee = 3, WorkedDate = Convert.ToDateTime("07-13-2022"), ShiftStartTime = "13:00",ShiftEndTime = "19:00", ID_StatusShift = 1},
                new Shift{ ID_Employee = 3, WorkedDate = Convert.ToDateTime("06-15-2022"), ShiftStartTime = "07:00",ShiftEndTime = "12:00", ID_StatusShift = 1},
                new Shift{ ID_Employee = 1, WorkedDate = Convert.ToDateTime("08-14-2022"), ShiftStartTime = "07:00", ShiftEndTime = "12:00",ID_StatusShift = 1},
            });
            context.SaveChanges();
            context.HistoryPayrolls.AddRange(new HistoryPayroll[]
            {
                new HistoryPayroll{ID_User =2,ID_Shift = 1},
                new HistoryPayroll{ID_User =3, ID_Shift =2},
                new HistoryPayroll{ID_User =1, ID_Shift=3},
                new HistoryPayroll{ID_User =2, ID_Shift=4}
            });

            context.Products.AddRange(new Product[] {
                new Product { ID_Category = 1, NameProduct = "Mì Tôm", ID_Unit = 3, Price = 15 , Amount = 55},
                new Product {ID_Category = 2, NameProduct = "Bia", ID_Unit = 2, Price = 10 , Amount =34},
                new Product { ID_Category = 2, NameProduct = "Pepsi", ID_Unit = 2, Price = 8 , Amount =88},
                new Product {ID_Category = 3, NameProduct = "Coca Cola", ID_Unit = 2, Price = 8 , Amount = 883},
                new Product {ID_Category = 1, NameProduct = "Bánh Mì", ID_Unit = 1, Price = 10 , Amount = 11}
            });
            context.SaveChanges();
            context.Inventorys.AddRange(new Inventory[] {
                new Inventory {Amount = 20,ImportDay = Convert.ToDateTime("06-13-2022"), ExpiryDate = Convert.ToDateTime("06-13-2022"), ImportPrices = 12, SalePrice = 15, ID_Product = 1},
                new Inventory {Amount = 15,ImportDay = Convert.ToDateTime("06-13-2022"), ExpiryDate = Convert.ToDateTime("09-13-2023"), ImportPrices = 16, SalePrice = 18, ID_Product = 3},
                new Inventory {Amount = 20,ImportDay = Convert.ToDateTime("06-13-2022"), ExpiryDate = Convert.ToDateTime("06-13-2022"), ImportPrices = 5, SalePrice = 10, ID_Product = 2},
                new Inventory {Amount = 10,ImportDay = Convert.ToDateTime("06-13-2022"), ExpiryDate = Convert.ToDateTime("06-13-2022"), ImportPrices = 8, SalePrice = 10, ID_Product = 5},
                new Inventory {Amount = 30,ImportDay = Convert.ToDateTime("06-13-2022"), ExpiryDate = Convert.ToDateTime("06-13-2022"), ImportPrices = 5, SalePrice = 10, ID_Product = 4}
            });
            ...
            context.OrderDetails.AddRange(new OrderDetail[]{
                ...
                new OrderDetail { ID_Product = 2, ID_Order = 2, _Description = "abcd", Quality =3},
